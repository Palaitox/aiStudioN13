  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="text-center mb-10">
        <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-300 mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select 
                className="w-full bg-slate-800/50 border border-white/10 rounded-lg p-3 text-white focus:ring-2 focus:ring-blue-500 outline-none"
                value={formData.type}
            ...
            <div className="space-y-2">
              ...
              <select className="w-full bg-slate-800/50 border border-white/10 rounded-lg p-3 text-white focus:ring-2 focus:ring-blue-500 outline-none">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              required
              rows={5}
              className="w-full bg-slate-800/50 border border-white/10 rounded-lg p-3 text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none"
              ...
              <div className="text-sm text-slate-300">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="terms" className="cursor-pointer hover:text-white transition-colors">
                    He leído y acepto la <span className="underline decoration-blue-400 text-blue-300">Política de Privacidad</span> y los <span className="underline decoration-blue-400 text-blue-300">Términos y Condiciones</span>.
                  </label>
                </div>
              </div>
            </div>
          ...
          <button 
            ...
            className={`
              ...
              ${acceptedTerms 
                ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg hover:shadow-cyan-500/25 transform hover:-translate-y-1' 

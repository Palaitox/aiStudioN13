...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-brand-primary hover:bg-blue-500 text-white shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] border border-transparent",
    secondary: "bg-brand-secondary hover:bg-sky-300 text-slate-900 shadow-lg border border-transparent",
